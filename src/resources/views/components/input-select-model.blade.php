...
@endif
<div class="relative z-0 mb-6 w-full group option-search-model">
...
<div class="setStyleSelectModel"></div>
<div class="setDarkStyleSelectModel"></div>
<script defer>
    function setSelectDarkModeSelectModel() {
        ...
        document.querySelector('.setDarkStyleSelectModel').innerHTML = `
        <style>
    ...
    document.querySelector('.setStyleSelectModel').innerHTML = `
        <style>
